        ...
        <div>
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full bg-white p-3 pl-8 rounded-xl text-lg font-medium text-gray-800 border-none focus:ring-2 focus:ring-blue-500 outline-none shadow-sm placeholder:text-gray-300"
              placeholder="0"
            />
          </div>
          {totalDeduction > 0 && (
            <p className="text-gray-500 text-xs mt-1 ml-1">
              總扣除金額：<span className="font-medium text-gray-700">${totalDeduction.toLocaleString()}</span>
            </p>
          )}
        </div>
